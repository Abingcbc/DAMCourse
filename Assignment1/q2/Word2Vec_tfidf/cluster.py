...
user_id = pd.read_csv("feature_word_tfidf.csv").values[:,0]
X = pd.read_csv("feature_word_tfidf.csv").values[:,1:]
...
# Density Peak 0.07211952708941839 3452.8558748625755
...
# K-Means 0.6052216178899797 24517.296722533105
print("----- K-Means start -----")
start = time.time()
...
#DBSCAN 0.2610339867705774 1099.5330391988073
print("----- DBSCAN start -----")
start = time.time()
cluster_db = DBSCAN(eps=0.001, min_samples=58)
...
# #Hierarchical Clustering 0.5122250157310574 20681.621962140573
...
#Spectral Clustering 0.6235519958715413 13216.410690802119
print("----- Spectral Clustering start -----")
start = time.time()
cluster_sc = SpectralClustering(n_clusters=4, gamma=0.1)
...
# #EM-GMM 0.6018571193297448 7260.146641483644
print("----- EM-GMM -----")
start = time.time()
